export const abis = [
  ...
  {
    inputs: [{ internalType: 'address', name: 'fromOperator', type: 'address' }],
  ...
  },
  {
    inputs: [{ internalType: 'bytes32', name: 'tokenId', type: 'bytes32' }],
    name: 'flowInAmount',
    outputs: [{ internalType: 'uint256', name: 'flowInAmount_', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
  ...
  },
  {
    inputs: [{ internalType: 'bytes32', name: 'tokenId', type: 'bytes32' }],
    name: 'flowOutAmount',
    outputs: [{ internalType: 'uint256', name: 'flowOutAmount_', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
  ...
  },
  {
    inputs: [{ internalType: 'string', name: 'chain', type: 'string' }],
    name: 'trustedAddress',
    outputs: [{ internalType: 'string', name: 'trustedAddress_', type: 'string' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
